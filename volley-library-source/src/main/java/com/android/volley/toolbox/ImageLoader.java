...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        //创建一个包含空bitmap的imageContainer，用于封装显示默认的图片
        ...
        //通过mInFlightRequests来判断这次请求是否发起
        //如果该请求已经发起请求了，将请求结果封装到imageContainer中
        ...
        // track it.
        //如果这次请求图片，还没有发起请求，也就是一次新的请求，创建一个新的request
        //
        Request<Bitmap> newRequest = makeImageRequest(requestUrl, maxWidth, maxHeight, scaleType,
                cacheKey);

        //将这次新的请求添加到请求队列中，执行网络请求， 查看ImageRequest执行请求逻辑
