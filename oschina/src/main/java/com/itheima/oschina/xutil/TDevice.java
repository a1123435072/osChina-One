package com.itheima.oschina.xutil;
...
import com.itheima.oschina.OschinaApplication;
...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return OschinaApplication.getContext().getResources().getDisplayMetrics();
    }
    ...
    public static boolean hasInternet() {
        ConnectivityManager cm = (ConnectivityManager) OschinaApplication.getContext()
    ...
    public static boolean isPortrait() {
        return OschinaApplication.getContext().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = OschinaApplication.getContext().getResources().getConfiguration().screenLayout;
    ...
    public static void gotoMarket(Context context, String pck) {
        if (!isHaveMarket(context)) {
            Toast.makeText(OschinaApplication.getContext(),"你手机中没有安装应用市场", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public static int getVersionCode() {
        return getVersionCode(OschinaApplication.getContext().getPackageName());
    }
    ...
    public static String getVersionName() {
        try {
            return OschinaApplication.getContext()
                    ...
                    .getPackageManager()
                    .getPackageInfo(OschinaApplication.getContext().getPackageName(), 0)
                    .versionName;
        } catch (PackageManager.NameNotFoundException ex) {
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) OschinaApplication.getContext()
                .getSystemService(Context.CLIPBOARD_SERVICE);
        clip.setText(string);
        Toast.makeText(OschinaApplication.getContext(), R.string.copy_success, Toast.LENGTH_SHORT).show();
    }
